    ...
    <>
      <div style={{ border: '1px solid #ddd', padding: 10, width: 320 }}>
        ...
        <div style={{ marginBottom: 8 }}>
          <button onClick={() => dispatch(increment())} style={{ marginRight: 8 }}>Increment</button>
        ...
        <div style={{ marginBottom: 8 }}>
          ...
          />
          <button onClick={() => dispatch(incrementByAmount(amount))} style={{ marginLeft: 8 }}>Add Amount</button>
        </div>
